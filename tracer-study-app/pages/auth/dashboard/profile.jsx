...
export default function ProfilePage() {
    ...
    useEffect(() => {
        if (reload == true) {
            setLoader(true);
            AxiosInstance.get(`/konten/profile`)
                .then((res) => {
                    setLoader(false);
                    setReload(false);
                    setDataProfile({
    ...
    const handlerSubmit = (e) => {
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                ...
                if (profileForm.id == 0) {
                    AxiosInstance.post(`/konten/profile/store`, profileForm)
                        .then((res) => {
                            setReload(true);
                    ...
                    AxiosInstance.post(`/konten/profile/update`, profileForm)
                        .then((res) => {
                            setReload(true);
                            setModalProfile(false);
                            Swal.fire({
                            ...
                            <>
                                <div className="flex justify-center">
                                    <img
                                        src={
                                            dataProfile.logo
                                                ? `${process.env.NEXT_PUBLIC_BASE_URL}/storage/Profile/Logo/${dataProfile.logo}`
                                                : "/profil_img.jpg"
                                        }
                                        alt=""
