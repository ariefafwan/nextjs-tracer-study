...
export default function PertanyaanCreatePage() {
    ...
    useEffect(() => {
        AxiosInstance.get(`/pertanyaan/pertanyaan/create`)
            .then((res) => {
    ...
    useEffect(() => {
        if (pertanyaanForm.tipe_pertanyaan.value == "Sub_Pertanyaan") {
            if (pertanyaanForm.id_parent.value != "") {
                AxiosInstance.get(
                    `/pertanyaan/pertanyaan/data/${pertanyaanForm.id_parent.value}`
                )
                    .then((res) => {
                        setPertanyaanForm({
                            ...pertanyaanForm,
    ...
    return (
        <>
            <DashboardLayout title="Tambah Pertanyaan">
                                            ...
                                            <div className="grid gap-4 gap-y-2 text-sm grid-cols-1 md:grid-cols-6">
                                                ...
                                                <div className="w-full">
                                                    ...
                                                    <input
                                                        ...
                                                        required
                                                        className="h-9.5 border border-gray-300 rounded px-4 py-2 w-full bg-white"
                                                    />
                                                </div>
                    ...
                    <div className="block">
                        {pertanyaanForm.tipe_pertanyaan.value !== "" ? (
                            ...
                            <p className="text-gray-500 italic">
                                Pilih Tipe Pertanyaan Terlebih Dahulu
                            </p>
                        )}
                    </div>
                </ModalSecondary>
