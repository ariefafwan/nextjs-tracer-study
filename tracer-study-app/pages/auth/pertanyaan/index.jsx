...
export default function PertanyaanPage() {
    ...
    const handleDelete = (id) => {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                ...
                AxiosInstance.delete(`/pertanyaan/pertanyaan/delete/${id}`)
                    .then((res) => {
                        setReloadTable(true);
                        Swal.fire({
                            title: "Success!",
    ...
    return (
        <>
            <DashboardLayout title="Master Pertanyaan">
                <div className="w-full px-4 py-2 mt-12">
                    <div className="relative overflow-x-auto shadow-xl sm:rounded-lg">
                        <TableData
                            ...
                            buttonModal={() =>
                                navigate.push("/auth/pertanyaan/create")
                            }
                        >
                                            ...
                                            >
                                                ...
                                                <td className="py-3 text-center text-black">
                                                    <div>
                                                        <Link
                                                            type="button"
                                                            href={`/auth/pertanyaan/edit/${all.id}`}
