...
export default function PertanyaanEditPage({ slug }) {
    ...
    useEffect(() => {
        AxiosInstance.get(`/pertanyaan/pertanyaan/edit/${id}`)
            .then((res) => {
    ...
    return (
        <>
            <DashboardLayout title="Edit Pertanyaan">
