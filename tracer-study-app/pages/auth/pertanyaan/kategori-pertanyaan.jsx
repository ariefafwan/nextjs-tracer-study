...
export default function KategoriPertanyaanPage() {
    ...
    const editData = (id) => {
        AxiosInstance.get(`/pertanyaan/kategori-pertanyaan/edit/${id}`)
            .then((res) => {
                setKategoriPertanyaanForm({
                    id: res.data.id,
                    nama: res.data.nama,
    ...
    return (
        <>
            <DashboardLayout title="Master Kategori Pertanyaan">
