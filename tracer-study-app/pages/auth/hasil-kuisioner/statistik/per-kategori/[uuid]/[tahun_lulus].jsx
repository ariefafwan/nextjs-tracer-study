...
export default function StatistikPerKategoriPage({ slug }) {
    let navigate = useRouter();
    let { uuid, tahun_lulus } = slug;
    ...
    useEffect(() => {
        setLoading(true);
        AxiosInstance.get(
            `/hasil/statistik/statistik-per-kategori/${uuid}/${tahun_lulus}`
        )
            .then((res) => {
    ...
    return (
        <DashboardLayout title="Statistik Hasil Kuisioner Per Kategori">
                                        ...
                                        <div key={index} className="mb-4">
                                            <div className="w-full">
                                                <p className="block mb-2 text-sm font-bold text-gray-900">
                                                    ...
                                                    &nbsp;
                                                    <Link
                                                        href={`/auth/hasil/statistik/per-pertanyaan/${data.id_pertanyaan}/${tahun_lulus}`}
