...
export default function StatistikPerPertanyaan({ slug }) {
    ...
    useEffect(() => {
        setLoading(true);
        AxiosInstance.get(
            `/hasil/statistik/statistik-per-pertanyaan/${uuid}/${tahun_lulus}`
        )
            .then((res) => {
    ...
    return (
        <DashboardLayout title="Statistik Hasil Kuisioner Per Pertanyaan">
