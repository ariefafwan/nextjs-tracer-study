...
export default function HasilPertanyaan() {
    ...
    useEffect(() => {
        ...
        AxiosInstance.get(
            `/hasil/hasil?page=${page}&q=${search}&paginate=${paginate}&fakultas=${fakultas}&prodi=${prodi}&daritanggal=${filterTanggalDari}&ketanggal=${filterTanggalKe}&tahun_lulus=${filterTahunLulus.value}`
        )
            .then((res) => {
                setAllData({
    ...
    useEffect(() => {
        setLoader(true);
        setReloadTable(false);
        AxiosInstance.get(`/hasil/hasil/create`)
            .then((res) => {
    ...
    const handleDelete = (id) => {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                ...
                AxiosInstance.delete(`/hasil/hasil/delete/${id}`)
                    .then((res) => {
                        setReloadTable(true);
                        Swal.fire({
                            title: "Success!",
    ...
    return (
        <>
            <DashboardLayout title="Hasil Kuisioner">
                                            ...
                                            >
                                                ...
                                                <td className="py-4 text-black">
                                                    <div className="inline-flex justify-center">
                                                        <Link
                                                            type="button"
                                                            href={`/auth/hasil-kuisioner/${all.id}`}
