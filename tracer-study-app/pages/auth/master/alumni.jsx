...
export default function MasterAlumniPage() {
    ...
    useEffect(() => {
        ...
        AxiosInstance.get(
            `/pengguna/alumni?page=${page}&q=${search}&paginate=${paginate}&fakultas=${fakultas}&prodi=${prodi}&status=${filterStatus}&tahun_lulus=${filterTahunLulus.value}`
        )
            .then((res) => {
                setAllData({
    ...
    useEffect(() => {
        setLoader(true);
        setReloadTable(false);
        AxiosInstance.get(`/pengguna/alumni/create`)
            .then((res) => {
    ...
    const handlerSubmit = (e) => {
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                ...
                if (alumniForm.id == 0) {
                    AxiosInstance.post(`/pengguna/alumni/store`, alumniForm, {
                        headers: {
                    ...
                    AxiosInstance.post(`/pengguna/alumni/update`, alumniForm, {
                        headers: {
                            "Content-Type": "multipart/form-data",
                        },
                    })
    ...
    const editData = (id) => {
        AxiosInstance.get(`/pengguna/alumni/edit/${id}`)
            .then((res) => {
                setSelectFakultas({
    ...
    const handleDelete = (id) => {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                ...
                AxiosInstance.delete(`/pengguna/alumni/delete/${id}`)
                    .then((res) => {
                        setReloadTable(true);
                        Swal.fire({
                            title: "Success!",
    ...
    return (
        <>
            <DashboardLayout title="Master Alumni">
                                ...
                                <>
                                    <div className="relative">
                                        <select
                                            ...
                                            className="h-full border block appearance-none w-40 text-ellipsis bg-white border-gray-300 text-gray-700 py-2 px-2 pr-8 leading-tight focus:outline-none focus:bg-white focus:border-gray-500"
                                        >
                                                    ...
                                                    <img
                                                        ...
                                                        src={
                                                            all.profile !==
                                                                null ||
                                                            all.profile !== ""
                                                                ? `${process.env.NEXT_PUBLIC_BASE_URL}/storage/Alumni/${all.profile}`
                                                                : "/profil_img.jpg"
                                                        }
                                                        alt="Bordered avatar"
                                                    />
