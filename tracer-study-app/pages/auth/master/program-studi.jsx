...
export default function ProgramStudiPage() {
    ...
    useEffect(() => {
        setLoader(true);
        setReloadTable(false);
        AxiosInstance.get(`/data-master/prodi/create`)
            .then((res) => {
    ...
    const handlerSubmit = (e) => {
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                ...
                if (prodiForm.id == 0) {
                    AxiosInstance.post(`/data-master/prodi/store`, prodiForm)
                        .then((res) => {
                            setReloadTable(true);
                            setModalProdi(false);
                            Swal.fire({
                    ...
                    AxiosInstance.post(`/data-master/prodi/update`, prodiForm)
                        .then((res) => {
                            setReloadTable(true);
                            setModalProdi(false);
                            Swal.fire({
    ...
    const editData = (id) => {
        AxiosInstance.get(`/data-master/prodi/edit/${id}`)
            .then((res) => {
                setProdiForm({
                    id: res.data.id,
                    nama: res.data.nama,
    ...
    const handleDelete = (id) => {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                ...
                AxiosInstance.delete(`/data-master/prodi/delete/${id}`)
                    .then((res) => {
                        setReloadTable(true);
                        Swal.fire({
                            title: "Success!",
    ...
    return (
        <>
            <DashboardLayout title="Master Program Studi">
