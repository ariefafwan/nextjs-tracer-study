...
export default function MasterDosenPage() {
    ...
    useEffect(() => {
        setLoader(true);
        setReloadTable(false);
        AxiosInstance.get(`/pengguna/dosen/create`)
            .then((res) => {
    ...
    const handlerSubmit = (e) => {
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                ...
                if (dosenForm.id == 0) {
                    AxiosInstance.post(`/pengguna/dosen/store`, dosenForm)
                        .then((res) => {
                            setReloadTable(true);
                            setModalDosen(false);
                            Swal.fire({
                    ...
                    AxiosInstance.post(`/pengguna/dosen/update`, dosenForm)
                        .then((res) => {
                            setReloadTable(true);
                            setModalDosen(false);
                            Swal.fire({
    ...
    const editData = (id) => {
        AxiosInstance.get(`/pengguna/dosen/edit/${id}`)
            .then((res) => {
    ...
    const handleDelete = (id) => {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                ...
                AxiosInstance.delete(`/pengguna/dosen/delete/${id}`)
                    .then((res) => {
                        setReloadTable(true);
                        Swal.fire({
                            title: "Success!",
    ...
    return (
        <>
            <DashboardLayout title={"Master Dosen"}>
