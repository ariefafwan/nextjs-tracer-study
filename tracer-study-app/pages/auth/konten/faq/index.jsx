...
export default function MasterFaqPage() {
    ...
    const handlerSubmit = (e) => {
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                ...
                if (faqForm.id == 0) {
                    AxiosInstance.post(`/konten/faq/store`, faqForm)
                        .then((res) => {
                            setReloadTable(true);
                            setModalFaq(false);
                            Swal.fire({
                    ...
                    AxiosInstance.post(`/konten/faq/update`, faqForm)
                        .then((res) => {
                            setReloadTable(true);
                            setModalFaq(false);
                            Swal.fire({
    ...
    const editData = (id) => {
        AxiosInstance.get(`/konten/faq/edit/${id}`)
            .then((res) => {
                setFaqForm({
                    id: res.data.id,
    ...
    const handleDelete = (id) => {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                ...
                AxiosInstance.delete(`/konten/faq/delete/${id}`)
                    .then((res) => {
                        setReloadTable(true);
                        Swal.fire({
                            title: "Success!",
    ...
    return (
        <>
            <DashboardLayout title="Master FAQ">
