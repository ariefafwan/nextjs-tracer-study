...
export default function MasterKontenPage() {
    ...
    const handlerSubmit = (e) => {
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                ...
                if (kontenForm.id == 0) {
                    AxiosInstance.post(`/konten/konten/store`, kontenForm, {
                        headers: {
                    ...
                    AxiosInstance.post(`/konten/konten/update`, kontenForm, {
                        headers: {
                            "Content-Type": "multipart/form-data",
                        },
                    })
    ...
    const editData = (id) => {
        AxiosInstance.get(`/konten/konten/edit/${id}`)
            .then((res) => {
                setKontenForm({
                    id: res.data.id,
                    nama: res.data.nama,
    ...
    return (
        <>
            <DashboardLayout title="Master Konten Website">
