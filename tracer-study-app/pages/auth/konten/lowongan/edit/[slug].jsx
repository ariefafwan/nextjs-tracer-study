...
export default function MasterEditLowonganPage({ params }) {
    ...
    useEffect(() => {
        AxiosInstance.get(`/konten/lowongan/edit/${slug}`)
            .then((res) => {
                setLowonganForm({
                    id: res.data.id,
    ...
    useEffect(() => {
        AxiosInstance.get(`/konten/lowongan/data`)
            .then((res) => {
    ...
    const handlerSubmit = (e) => {
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                ...
                AxiosInstance.post(`/konten/lowongan/update`, lowonganForm)
                    .then((res) => {
                        Swal.fire({
                            title: "Success!",
    ...
    return (
        <>
            <DashboardLayout title="Edit Lowongan Pekerjaan">
                                            ...
                                            <div className="grid gap-4 gap-y-2 text-sm grid-cols-1 md:grid-cols-6">
                                                ...
                                                <div className="md:col-span-3">
                                                    ...
                                                    <input
                                                        ...
                                                        className="h-10 border border-gray-200 mt-1 rounded px-4 py-2 w-full bg-gray-50"
                                                    />
                                                </div>
                                                <div className="md:col-span-3">
